...
def check_pumatong(pumatong,pinatungan):
    ...
    if pumatong != pinatungan:
        ...
        cv2.putText(frame,pumatong + " and " + pinatungan + " are having it.",(50,50), cv2.FONT_HERSHEY_COMPLEX, 1 ,(0,255,0), 2)
        print(pumatong + "=>" + pinatungan)

cap = cv2.VideoCapture(0)

# Load our image template, this is our reference image
image_template = cv2.imread('images/COW_A.jpg', 0)
image_template2 = cv2.imread('images/COW_B.jpg',0)
image_template3 = cv2.imread('images/COW_C.jpg',0)
...
while True:
        ...
        if matches > threshold:
            ...
            if(third_stack == current_detect):
                ...
                if not has_drawn_already:
                    ...
                    check_pumatong(current_detect,previous_detect)
                else:
                    has_drawn_already = False
    ...
    cv2.imshow('Estrus Patong Detection', frame)
